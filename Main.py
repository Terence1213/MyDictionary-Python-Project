...
def quiz():
    ...
    # The questions are asked (for all the already entered words in the program)
    for key in shuffledWords:
        print("--------------------------------------------------")
        answer = input("What is the definition of the word: " + key + "?: ")
        print("\nYour answer: " + answer)
    ...
    print("------------------------------------------------")
    print("Your total score was: " + str((score / len(wordsEntered) * 100)) + "%")
